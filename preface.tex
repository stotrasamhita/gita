...
This document is organised into five parts: (1)~\textbf{मूलम्} (\textit{Bhagavadgītā Mūlam}), (2)~\textbf{पदच्छेदः} (Word Splits), (3)~\textbf{पद्मपुराणान्तर्गत-गीता-माहात्म्यम्}, the detailed (chapter-wise!) Māhātmyam of Bhagavad Gita from the Padma Puranam, (4)~\textbf{श्लोकानुक्रमणिका} (Index of Verses), and (5)~\textbf{पदानुक्रमणिका} (Word Index). The indices (4) and (5) were generated using a custom Python script co-developed with Gemini 3.0 Pro. All source materials are available at \url{http://github.com/Stotrasamhita/gita/)} for adaptation and re-use. Key features include:
